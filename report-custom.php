...
$adjusted_quantities = isset($_POST['adjusted_quantities']) ? $_POST['adjusted_quantities'] : [];
            ...
            <div class="box-invoice"> 
                <div class="inner-invoice"> 
                    ...
                    <tbody>
                        ...
                        // Fetch the data from the hidden form inputs
                        ...
                        $selected_quantity = floatval($_POST['selected_quantity']); // Assuming this is provided
                        $total_value = floatval($_POST['total_value']); // Assuming this is provided

                        foreach ($ingredient_ids as $index => $id) {
                            $ingredient_name = htmlspecialchars($ingredient_names[$index]);
                            $quantity = isset($adjusted_quantities[$index]) ? floatval($adjusted_quantities[$index]) : 0; // Use adjusted quantity
