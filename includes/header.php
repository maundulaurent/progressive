				...
				<div class="container-fluid">
					<nav class="navbar navbar-expand-lg header-nav p-0">
						...
						<ul class="nav header-navbar-rht reg-head">												
							...
							<li><a href="register.html" class="reg-btn">Become a Seller</a></li>
							<li><a href="register.html" class="reg-btn"><img src="/projects/quotations/assets/img/icon/users.svg" class="me-1" alt="img">Register</a></li>
							<li><a href="login.html" class="log-btn"><img src="/projects/quotations/assets/img/icon/lock.svg" class="me-1" alt="img"> Login</a></li>
							<li><a href="/projects/quotations/buyer/post-quotation" class="login-btn"><i class="feather-plus me-1"></i>Post a Quotatioon </a></li>
						</ul>
					</nav>
				</div>
