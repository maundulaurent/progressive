 ...
 /*chart-area-spline-sracked*/
	...
	var chart = c3.generate({
		...
		data: {
			columns: [
				// each columns data
				['data1', 0, 5, 16, 7, 20, 23 , 7, 21 , 10 , 7 , 10],
			],
	...
	var chart = c3.generate({
		bindto: '#chart-freelance', // id of chart wrapper
		data: {
			columns: [
				// each columns data
				['data1', 10, 5, 12, 7, 20, 13 , 17, 21 , 10 , 7 , 10],
			],
			type: 'spline', // default type of chart
			groups: [
				[ 'data1', 'data2']
 ...
 /*chart-bar*/
	...
	var chart = c3.generate({
		bindto: '#chart-bar-biding', // id of chart wrapper
		data: {
			columns: [
				// each columns data
				['data1', 4, 2, 8, 10, 9, 17, 0, 25, 2, 0, 14,4],
				['data2', 30, 20, 18, 47, 19, 52, 4, 16, 42, 15, 12, 18 ]
			],
			type: 'bar', // default type of chart
			groups: [
				[ 'data1', 'data2']
